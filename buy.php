...
-->
  ...
  <body>
    ...
    <!--  <div class="col-6 red t_center t_white" onclick="setPresent('buy.php');loadPage('otp_authentication/buy_index.php');">
        <h2></h2>
      </div>
    -->
     <div class="col-12">
    <!--<div class="col-6 orange t_center t_white" onclick="setPresent('');loadPage('')">
     ...
     <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
       <table>
         <tr><td>Phone:</td><td> <input type="text" name="phone" placeholder="Phone Number"></td></tr>
