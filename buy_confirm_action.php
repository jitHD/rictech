...
if(isset($_GET['id']))
{
  ...
  $upd1=mysqli_query($conn,"INSERT INTO `buy_requests` (`id`,`product_id`,`seller`,`buyer`,`request_date`) VALUES (NULL,'$product_id','$seller','$buyer',CURRENT_TIMESTAMP)") or die(mysqli_error($conn));
